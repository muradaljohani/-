...
import { 
    ...
    Repeat, Share2, ArrowLeft, MoreVertical, Plus, CheckCircle2 
} from 'lucide-react';
...
const POSTS = [
    {
        id: 1,
        user: { name: 'Murad Aljohani', handle: '@murad', avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=Murad' },
        time: '2h',
    ...
    {
        id: 2,
        user: { name: 'Sarah Tech', handle: '@sarah_dev', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah' },
        time: '5h',
    ...
    {
        id: 3,
        user: { name: 'Khaled Design', handle: '@k_art', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Khaled' },
        time: '1d',
